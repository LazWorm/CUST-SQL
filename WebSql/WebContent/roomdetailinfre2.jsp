...
<html>
    ...
    <body>
        ...
        <div class="head">
          <h2 class="tablet">客房详细信息 点击预定</h2>
        </div>
        ...
        {%>
          ...
          <%i=0;} %>
              ...
              <%if(!rs.getString("入住状态").startsWith("yes")) {%>
                    <td align="center"><a href="insertelem.jsp?id=<%=rs.getString("入住状态")%>
            						&num=<%=rs.getString("房间编号")%>
            						&stanum=<%=rs.getString("类型编号")%>
            						&flag=<%=fla%>"><%=rs.getString("房间编号") %></a></td>
                
              <%}%>
            
              
              <%if(rs.getString("入住状态").startsWith("yes")) {%>
                    <td align="center" class="tableundo"><a href="insertelem.jsp?id=<%=rs.getString("入住状态")%>
            						&num=<%=rs.getString("房间编号")%>
            						&stanum=<%=rs.getString("类型编号")%>
            						&flag=<%=fla%>"><%=rs.getString("房间编号") %></a></td>
