...
<html>
    ...
    <body>
        ...
        //int bef=Integer.parseInt(inf3);
        //int aft=Integer.parseInt(inf4);
        //int day=aft-bef;
        //ResultSet rs2=stmt.executeQuery("select 类型编号  from 客房信息  where 房间编号= "+inf1);
        ...
        //String sqlins="insert into 入住信息  values("+"'"+inf1+"'"+","+"'"+inf2+"'"+","+"'"+inf3+"'"+","+inf4+","+"'"+inf5+"'"+","+"'"+"yes"+"'"+","+"300"+")";;
        %>
