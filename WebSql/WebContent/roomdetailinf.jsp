    ...
    <body>
        ...
        <table class="table1"  align="center" cellspacing="0">
          <tr>
            ...
            <td align="center">楼层信息</td>
            <td align="center">床数量</td>
            <td align="center">入住状态</td>
            <td align="center">入住操作</td>
            <td align="center">预定操作</td>
          </tr>
        <%
        ...
        {%>
          <tr>
            ...
            <td><%=rs.getString("类型编号") %></td>
            <td><%=rs.getString("楼层信息") %></td>
            <td><%=rs.getString("床数量") %></td>
            <td><%=rs.getString("入住状态") %></td>
            <td><a href="doroomnew.jsp?id=<%=rs.getString("入住状态")%>
            						&num=<%=rs.getString("房间编号")%>
            						&stanum=<%=rs.getString("类型编号")%>
            						&flag=<%=fla%>">办理入住</a></td>
            <td><a href="insertelem.jsp?id=<%=rs.getString("入住状态")%>
            						&num=<%=rs.getString("房间编号")%>
            						&stanum=<%=rs.getString("类型编号")%>
            						&flag=<%=fla%>">办理预定</a></td>
          </tr>
