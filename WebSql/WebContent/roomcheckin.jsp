...
<html>
    ...
    <body>
        ...
        ResultSet rs=stmt.executeQuery("select * from 订房信息");
        while(rs.next())
        {%>
          <tr>
            ...
            <td><a href="doRoomCkinRd.jsp?id=<%=rs.getString("房间编号") %>
            							&id2=<%=rs.getString("身份证号") %>
            							&id3=<%=rs.getString("到达时间") %>
            							&id4=<%=rs.getString("离开时间") %>
            							&id5=<%=rs.getString("入住人数") %>">确认到店</a></td>
            <td><a href="doRoomcan.jsp?id=<%=rs.getString("房间编号") %>
            							&id2=<%=rs.getString("身份证号") %>
            							&id3=<%=rs.getString("到达时间") %>
            							&id4=<%=rs.getString("离开时间") %>
            							&id5=<%=rs.getString("入住人数") %>">取消预定</a></td>
          </tr>
        <%}%>
          <tr>
            <td colspan="7"><a href="roomdetailinf.jsp">键入新信息</a></td>
          </tr>
     </table>
     <div class="dock">
     	<div class="dockposi">
